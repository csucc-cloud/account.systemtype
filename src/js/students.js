...
export const studentModule = {
    // Local storage for export functionality
    allStudentsData: [],
    ...
    render() {
        ...
        container.innerHTML = `
            <div class="space-y-6 p-4 animate-in fade-in duration-500">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-5 rounded-3xl shadow-sm border border-slate-100">
    ...
    async fetchAndRenderList(searchTerm = "") {
        ...
        try {
            ...
            this.allStudentsData = data; // Store for export functionality
            ...
            tbody.innerHTML = data.map(s => {
                ...
                <tr class="border-b border-slate-50 hover:bg-slate-50/80 transition-all group">
                    ...
                    <td class="p-5 font-bold text-sm text-slate-700">${s.full_name}</td>
    ...
    handleExportCSV() {
        ...
        const rows = this.allStudentsData.map(s => [
            s.student_id, 
            s.full_name, 
            s.college, 
            s.course, 
